/* See: https://github.com/zonpantli/Titanium-Coffeescript-Boilerplate/blob/master/Resources/vendor/titanium_utils.js */
exports.apply = function(object) {
   ...
   */
  object.locale = function(/*Object*/ map) {
  ...
  object.isAndroid = (Titanium.Platform.name == 'android');
  object.isNotAndroid = (Titanium.Platform.name != 'android');
};
